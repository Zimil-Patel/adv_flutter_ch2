...
class SettingListSectioWithImage extends StatelessWidget {
  const SettingListSectioWithImage({super.key, required this.list});

  final List<TileModelWithIconImage> list;
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            fit: BoxFit.cover,
            image: AssetImage('assets/settings/$icon.png'),
          ),
        ),
      ),
      title: Text(title),
